...
// Post de ACHADO (terceiro encontrou um pet): espelha o pino de
        ...
        function __setupBird() {
          ...
          // Faixa com efeito "pano tremulando no vento" via SHIMMER: mantém
          // o retângulo (texto legível) mas o fundo é um gradiente que
          // desliza da esquerda pra direita em loop, simulando reflexo de
          // luz sobre tecido. Efeito barato, GPU-accelerated, sem cortar
          // nada do conteúdo.
          var iconHtml =
            '<div style="display:flex; align-items:center; pointer-events:auto; cursor:pointer;">' +
              ...
              '<div class="bird-banner" style="display:flex; flex-direction:row; align-items:center; ' +
                'width:200px; height:40px; padding:4px 8px; border-radius:8px; ' +
                'color:#fff; flex-shrink:0; ' +
                'background:linear-gradient(110deg, #FF8A33 0%, #FFA54D 40%, #FFD580 50%, #FFA54D 60%, #FF8A33 100%); ' +
