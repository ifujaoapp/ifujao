          ...
          if (foundAt && withinFoundWindow(foundAt)) {
            ...
            return L.divIcon({
              ...
              html: '<div style="position:relative;width:64px;height:58px;">' +
                ...
                '</div>' +
                '<div class="pet-pin-label"><span class="pet-text-found-pill">🎉 Encontrado!</span></div>' +
                '</div>',
              iconSize: [64, 58],
              iconAnchor: [32, 40],
              popupAnchor: [0, -44],
